import 'package:demo_kai_morning_210303/model/new/driver/driver_view_list.dart';
import 'package:demo_kai_morning_210303/model/new/driver/driver_vz_done_list.dart';
import 'package:demo_kai_morning_210303/model/new/restaurant_view_list.dart';
...
import '../model/old/rider_model_state.dart';
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text("선택된 날짜: ${_selDay.year}년 ${_selDay.month}월 ${_selDay.day}일",
                        style: TextStyle(fontSize: 20.0,),),
                      Text("오늘 날짜: ${noww.year}년 ${noww.month}월 ${noww.day}일",
                        style: TextStyle(fontSize: 15.0,),),
                      (_selDay.day != noww.day) ? Text("!!오늘 날짜와 선택 날짜가 다릅니다.!!",
                        style: TextStyle(fontSize: 30, color: Colors.red),): Container(),
                      Container(
                        color: Colors.white,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            런치는 현재 배달 시간 12시밖에 없으니... 잠시 주석처리...
                      ...
                      Expanded(
                        child: IndexedStack(
                          index: selectedTap,
                          children: [
                            RestaurantViewList(selDay: _selDay, selTime: _selTime),
                            DriverViewList(selDay: _selDay, selTime: _selTime),
                            DriverDoneList(selDay: _selDay, selTime: _selTime)
                          ],
                        ),
                      )
                    ],
